...
const successItems = [
  {
    icon: (
      <FaHandshake color="#fafafa" className="panel-icon-styling" size="70px" />
    ),
    id: 1,
    count: 150,
    prefix: "",
  ...
  {
    icon: (
      <FaThumbsUp color="#fafafa" className="panel-icon-styling" size="70px" />
    ),
    id: 3,
    count: 98,
    prefix: "",
