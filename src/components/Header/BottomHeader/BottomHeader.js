                ...
                <Col md = "9" sm = "6" className='op-gns'>
                    <Navbar expand='lg' variant='dark'>
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <NavDropdown href="/home" title="Home" id='basic-nav-dropdown' menuVariant='dark'>
                            ...
                            <NavDropdown title="Practice Areas" id='basic-nav-dropdown' menuVariant='dark'>
                            ...
                            <NavDropdown title='Team Members' id='basic-nav-dropdown' menuVariant='dark' >
                                <NavDropdown.Item href='#' className='nav-link'>Robert Darren</NavDropdown.Item>
                            </NavDropdown>
                            <NavDropdown title='Pages' id='basic-nav-dropdown' menuVariant='dark'>
                            ...
                            <NavDropdown title='Blogs' id = 'basic-nav-dropwdown' menuVariant='dark'>
